      ...
      <div className="relative w-full" style={{ aspectRatio: '16/9', maxHeight: '75vh' }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-center text-white px-6 max-w-5xl">
            ...
            <p
              className="font-light italic text-white/90 max-w-2xl mx-auto mb-8"
              style={{
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <button
                ...
                className="bg-golden-yellow hover:bg-yellow-400 text-slate-900 font-bold uppercase tracking-wider rounded-lg transition-all duration-300 shadow-2xl hover:scale-105 active:scale-95 px-8 py-3 text-sm"
              >
                VIEW EXPEDITIONS
              </button>
              ...
              <Link
                to="/contact"
                className="bg-slate-800/80 hover:bg-slate-700 backdrop-blur-sm border border-white/20 text-white font-bold uppercase tracking-wider rounded-lg transition-all duration-300 shadow-xl hover:scale-105 active:scale-95 px-8 py-3 text-sm"
              >
                CONTACT US
              </Link>
            </div>
