 ...
 * 
 * Renders WhatsApp button and Chatbot as fixed floating actions.
 * Uses React Portal to render outside the normal DOM hierarchy,
 * preventing parent transform/overflow from breaking fixed positioning.
 */
...
export default function FloatingActionsPortal() {
  ...
  return createPortal(
    <div className="floating-actions">
      ...
      {/* Chatbot Component - Opens floating widget */}
      <Chatbot />
    </div>,
    document.body
  );
