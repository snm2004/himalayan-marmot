...
const Festivals: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO
        title="Ladakh Festivals 2025"
        description="Experience the vibrant culture of Ladakh. Upcoming festivals: Hemis, Thiksey, and more. Book a festival special tour."
        url="/festivals"
      />
      {/* Header */}
